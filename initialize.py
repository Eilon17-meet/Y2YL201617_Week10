...
products = [
    {'name':'m16 rifle', 'description':wikipedia.summary(wikipedia.search('m16 rifle')[0],sentences=1), 'photo':'http://andyzworld.com/wp-content/uploads/2015/08/M16.jpg', 'price':'$2799.99'},
    {'name':'uzi', 'description':wikipedia.summary(wikipedia.search('uzi')[0],sentences=1), 'photo':'http://vignette4.wikia.nocookie.net/roblox-apocalypse-rising/images/8/87/Replica_Uzi.jpg/revision/latest?cb=20150128093212', 'price':'$1299.99'},
    {'name':'desert eagel', 'description':wikipedia.summary(wikipedia.search('imi desert eagle')[0],sentences=1), 'photo':'http://www.gunsandammo.com/files/2016/01/desert-eagle-lightweight-1.jpg', 'price':'$1599.99'},
...
for product in products:
    newProduct = Product(name=product['name'].title(), description=product['description'], photo=product['photo'], price=product['price'])
