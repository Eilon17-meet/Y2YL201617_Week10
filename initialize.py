...
choice=eval(raw_input("Delete also data? ('True' / 'False') ").capitalize())
if choice:
...
products = [
	...
	{'name':'Peach', 'description':'Fuzzy Navel of Refreshment', 'photo':'https://s3.amazonaws.com/static.caloriecount.about.com/images/medium/big-peach-soda-84751.jpg', 'price':'$1.99','tags':'drink fruit'},
